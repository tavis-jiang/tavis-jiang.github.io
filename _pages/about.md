...
<div style="display: flex; align-items: flex-start; gap: 40px; margin-bottom: 20px;">
  <div style="flex: 0 0 260px;">
    <img src="/images/profile.png" style="width: 100%; border-radius: 4px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  </div>
