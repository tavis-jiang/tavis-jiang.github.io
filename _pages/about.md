...
我是上海交通大学电子信息与电气工程学院 (电院) 2024 级本科生。我是一名 **Fedora Linux** 爱好者，推崇 **Vim/Emacs** 键盘驱动的开发模式。目前我正在攻克 **MIT 6.006 (Algorithms)** 课程，并致力于在算法实现与系统底层探索中建立坚实的工程品味。

### 🔍 Research Interests / 研究兴趣
* **Artificial Intelligence:** High-efficiency architectures for LLMs and NLP. (大模型架构与自然语言处理)
* **Algorithm Theory:** Complexity analysis and data structures. (算法复杂性分析与数据结构)
* **System Security:** Linux-based system auditing and security. (基于 Linux 的系统安全实践)
